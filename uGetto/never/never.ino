...
//TODO: also 3 oktav elhagyasa, szamok kiszedese tombbe, prescaler optimalizalasa (tarolas helyett if)
...
// sajat formara alakitas
// egy hang egy byte
// duration bpm alapjan legrovidebb periodus egesz szamo tobbszorose
#define NOTE_C4  4, 0   
#define NOTE_D4  4, 2
#define NOTE_E4  4, 4
#define NOTE_F4  4, 5
...
void playNote(uint8_t octave, uint8_t note, uint16_t duration)
{
		tone(4, 7); // G
		_delay_ms(500);
}
